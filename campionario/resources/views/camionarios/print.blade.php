...
<div class="cont" style="border:1px solid black;">
        ...
        <div >
            ...
            <div >
            <div class="databox">
            <h6>@foreach($accessoires as $accessoire )
        ...
        <div >
            <h4>Couleur </h4>
            <div class="databox">
            <h6>{{ $fichecontrole->couleuraccessoire }}</h6>
            </div>
        </div>
        <div >
            <h4>Fournisseur </h4>
        ...
        <div >
            ...
            <div class="databox">
            <h6>{{ $fichecontrole->typecontrole }}</h6>
            </div>
